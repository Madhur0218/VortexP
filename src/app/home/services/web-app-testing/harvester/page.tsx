...
const Harvester: React.FC = () => {
    ...
    const [jobType, setJobType] = useState<string>("harvester");
    const [message, setMessage] = useState<string>("");
    const router = useRouter();

    const handleSubmit = () => {
        scheduleJob("harvester", { input: url }).then((res) => {
            console.log(res);
        })
    }
        ...
        <div className="bg-backgroundImage min-h-screen">
            <AppBar>
                <div className="flex gap-4">
                    ...
                    <h1 className="text-xl font-bold">theHarvester</h1>
                </div>
            </AppBar>
